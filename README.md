...
**STATE** - Breadboard and prototyping has been completed. Schematic has been created and a first draft of the PCB has been created and ordered.
...
## License
Both the software and documentation are under the MIT license, and the hardware will be licensed soon.
